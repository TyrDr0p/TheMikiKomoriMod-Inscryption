...
For Sigils and Talking Cards, nested schema-backed JSON editors are included for advanced structures such as `abilityBehaviour`, emotions, and dialogue events. Use **Validate Nested JSON** inside those editors when changing nested data.
